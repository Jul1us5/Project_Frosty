...
<script type="text/javascript">
    ...
    function show() {
        ...
        if (flag == 0) {
            $('.box').css({
                '-webkit-clip-path': 'polygon(0% 100%, 100% 100%, 100% 90%,85% 95%, 10% 78%, 7% 6%, 90% 5%, 85% 95%, 100% 95%, 100% 0%, 0% 0%, 0% 100%)'
            });
            flag = 1;
        } else {
            $('.box').css({
                '-webkit-clip-path': "polygon(0% 100%, 100% 100%, 100% 80%, 93% 85%, 8% 95%, 15% 6%, 89% 2%, 93% 85%, 100% 80%, 100% 0%, 0% 0%, 0% 100%)"
            });
            flag = 0;
        }
    }
