    ...
    <div class="container">
        <div class="row justify-content-center">
                            ...
                            <div class="filter">
                                <select name="rest">
                                    ...
                                    @foreach ($menus as $menu)
                                        <option class="options" value="{{ $menu->id }}" @if ($selectRest == $menu->id) selected
                ...
                @foreach ($restaurants as $key => $restaurant)
                    <a href="{{ route('restaurant.edit', [$restaurant]) }}">
                        <div class="menu_box">
                            ...
                            <a
                                href="{{ route('menu.show', [$restaurant->menu->id]) }}"><span>{{ $restaurant->menu->title }}</span></a>
            ...
            @else
                ...
                @if (!count($menus) == 0)
                    <div class="menu_box up"><a href="{{ route('restaurant.create') }}"><b>Pridėti naują restoraną</b></a>
                    </div>
                @endif
